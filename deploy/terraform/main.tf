...
data "aws_region" "backend" {}
data "aws_region" "frontend" {
  ...
  container_definitions = jsonencode([
    {
      ...
      logConfiguration = {
        ...
        options = {
          ...
          "awslogs-region"        = data.aws_region.backend.name
...
resource "aws_cloudfront_distribution" "static_assets" {
  ...
  default_root_object = "login/index.html"
...
# CloudFront Cache Policy (AWS Managed)
data "aws_cloudfront_cache_policy" "optimized" {
  provider = aws.frontend
  name = "Managed-CachingOptimized"
}

# CloudFront Origin Request Policy (AWS Managed)
...
# Route53 Record for CloudFront (optional, if using custom domain)
